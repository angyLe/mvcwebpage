...
namespace WebApplication1.Controllers
{
    public class AdminNewsController : Controller
    {
        ...
        public ActionResult GetImages(int NewsId)
        {
            ...
            ViewBag.Title = null;
            ViewBag.Image = OneNews.ImageLink;
        ...
        public async Task<ActionResult> Create([Bind(Include = "Title,Text,Annonce,ImageLink")] News news)
        {
            if (ModelState.IsValid)
            {

                ImageLink img = db.ImageLinks.Where(x => x.Link == news.ImageLink.Link).FirstOrDefault();
                db.News.Add(news);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "NewsId,Title,Text,Annonce,ImageLinkId")] News news)
        {
            if (ModelState.IsValid)
            {
